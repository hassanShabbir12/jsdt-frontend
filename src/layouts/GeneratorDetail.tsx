...
const GeneratorDetail = () => {
  return (
    <section className='relative w-full bg-accent py-24 text-neutral-900 sm:pb-60 sm:pt-40 lg:pb-[440px]'>
      <div className='container mx-auto px-4'>
        ...
        <div className='relative'>
          ...
          <h2 className='relative mx-auto mb-12 max-w-xs text-center text-3xl font-semibold leading-[1.2] text-zinc-800 sm:max-w-md sm:text-4xl md:mb-28 md:max-w-2xl md:text-6xl'>
        ...
        <div className='generator-image-area'>
          <div className='max-w-screen-xl flex-wrap justify-between md:flex'>
            <div className='relative z-50 mb-5 bg-white p-4 md:mb-0 md:w-2/6 lg:w-[427px] xl:ml-4'>
              <img className='block h-auto w-full' src={Exam01} alt='Exam01' />
            </div>
            <div className='relative z-50 mb-5 mr-0 mt-0 bg-white p-4 md:mb-0 md:w-2/6 lg:m-0 lg:mt-6 lg:w-[427px] xl:-mr-3.5'>
              <img className='block h-auto w-full' src={Exam02} alt='Exam02' />
            </div>
          </div>
          <div className='relative z-[9999] mx-auto mb-5 mt-0 bg-white p-4 md:-mt-32 md:mb-0 md:w-1/2 md:shadow-2xl lg:w-[427px] xl:ml-[430px]'>
            <img className='block h-auto w-full' src={Exam03} alt='Exam03' />
          </div>
          <div className='max-w-screen-xl flex-wrap justify-between md:flex'>
            <div className='relative z-50 mb-5 ml-0 bg-white p-4 md:-mt-40 md:mb-0 md:w-2/6 lg:mb-0 lg:w-[427px] xl:ml-44'>
              <img className='block h-auto w-full' src={Exam04} alt='Exam04' />
            </div>
            <div className='relative z-50 mb-5 mr-0 mt-0 bg-white p-4 md:-mt-40 md:mb-0 md:w-2/6 lg:w-[427px] xl:-mr-4 xl:-mt-10'>
