...
const Banner = () => {
  return (
    <section className='relative w-full overflow-hidden bg-accent pb-6 pt-6 text-neutral-900 sm:pb-20 sm:pt-16'>
      <div className='container relative mx-auto grid grid-cols-1 px-4 sm:grid-cols-2'>
