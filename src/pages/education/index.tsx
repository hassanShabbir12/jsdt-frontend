    ...
    <div className='sm:pl-32'>
      ...
      <div className='mb-5 sm:mb-10'>
        <Input
          type='text'
          placeholder='Grade:'
          className='h-12 w-full bg-blue-500 text-base font-semibold !text-white placeholder:text-white focus:bg-blue-500'
        />
      </div>
      ...
      <div className='mb-5 rounded-xl bg-blue-500 p-2 py-3 text-center text-sm text-white sm:mb-14 sm:px-9 sm:text-base'>
        ...
        elementum. Cras. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consequat nunc ac
        a magna at elementum. Cras.
      </div>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center'>
          <h3 className='-mr-2 sm:m-0 text-base text-zinc-800'>Please turnover</h3>
          <img
            src={assetUrl('assets/img/home/arrow-right-around.svg')}
            alt='round-arrow'
            className='m-0 sm:ml-2 block h-auto'
          />
        </div>
      </div>
    </div>
