    ...
    <div className='mx-auto max-w-[1340px] px-5'>
      ...
      <div className='max-w-[956px] font-montserrat text-base text-black'>
        ...
        <ol className='list-decimal pl-4'>
          ...
          <li className='mb-2'>
            <p className='mb-0'>
              Use the mark allocation and nature dl each question to determine the length and depth
              of an answer.
            </p>
          </li>
          <li className='mb-2'>
              ...
              <table className='mb-3 w-[680px] border-collapse border border-black'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border-2 border-black px-4 py-3 text-center font-semibold'>1</td>
                  ...
                  <tr>
                    ...
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>2</td>
                  ...
                  <tr>
                    ...
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>3</td>
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>
                      40
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>5</td>
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>
                      40
                    </td>
                  ...
                  <tr>
                    <td className='relative border-2 border-b-0 border-t-0 border-black px-4 py-3 font-semibold'></td>
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>6</td>
                    <td className='border-2 border-black px-4 py-2 text-center font-semibold'>
                      40
                    </td>
                    <td className='border-2 border-b-0 border-t-0 border-black px-4 py-2 text-center font-semibold'></td>
          ...
          <li className='mb-2'>
            <p className='mb-0'>
              Begin the answer to EACH question on a NEW page, e.g, QUESTION 1 - new page. QUESTION
              2 - new page.
            </p>
          </li>
          <li className='mb-2'>
